...
public class Main extends Application {
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("Palak Singh");
        alert.setContentText("I love to play around with code and create games. Connect 4 or Four-in-a-Row is one " +
                "of them. In free times I like to spend time with my nears and dears.");
